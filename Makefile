...
# coq_makefile Auto.v Basics.v Equiv.v Hoare2.v Hoare.v Imp.v Induction.v Lists.v Logic.v MoreCoq.v MoreProp.v MoreStlc.v Poly.v Prop.v References.v SfLib.v Smallstep.v StlcProp.v Stlc.v Sub.v Typechecking.v Types.v 
#
